...
export default function PasswordGeneratorTool() {
  ...
  const content =
    useToolContent<PasswordGeneratorToolContent>("password-generator");
    ...
    >
      ...
      {mode === "generate" ? (
        <>
          {/* Generate UI */}
          <div
            className={`relative flex items-center justify-between p-6 rounded-2xl border-2 mb-8 transition-all ${theme.bg} ${
              ...
              {[
                {
                  key: "uppercase",
                  label:
                    content.ui.generate.options.uppercase,
                },
                {
                  key: "lowercase",
                  label:
                    content.ui.generate.options.lowercase,
                },
                {
                  key: "numbers",
