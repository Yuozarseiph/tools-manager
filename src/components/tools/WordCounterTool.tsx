  ...
  return (
    <div className="grid lg:grid-cols-3 gap-8">
      ...
      >
        ...
        >
          <span
            className={`font-bold text-sm ${theme.text}`}
          >
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              {copied
                ? content.ui.buttons.copied
                : content.ui.buttons.copy}
            </button>
          </div>
        </div>
        <textarea
      ...
      <div className="space-y-4">
        ...
        >
          <div
            className={`p-3 rounded-full ${theme.secondary}`}
          >
            <Clock
              size={24}
              className={theme.accent}
...
function StatBox({ label, value, theme }: any) {
  return (
    <div
      className={`p-3 rounded-xl border ${theme.bg} ${theme.border}`}
    >
      <p
        className={`text-xs font-medium mb-1 ${theme.textMuted}`}
      >
        {label}
      </p>
      <p
