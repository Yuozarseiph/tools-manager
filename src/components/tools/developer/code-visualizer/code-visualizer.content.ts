...
export const codeVisualizerContent = {
  fa: {
    ...
    description:
      "کد جاوااسکریپت، سی‌شارپ یا جاوا خود را به یک نمودار گرافی تبدیل کنید تا وابستگی‌ها و ساختار آن را بهتر درک کنید.",
    features: [
      "پشتیبانی از زبان‌های JavaScript/TypeScript، C# و Java",
    ...
    ui: {
      header: {
        title: "بصری‌سازی کد",
        subtitleJs:
          "کد JavaScript/TypeScript را وارد کنید تا ساختار آن به صورت یک گراف قابل تعامل نمایش داده شود.",
        subtitleCsharp:
          "کد C# خود را وارد کنید تا کلاس‌ها، متدها و ارتباطات آن‌ها را در قالب گراف ببینید.",
        subtitleJava:
          "کد Java خود را وارد کنید تا کلاس‌ها، interfaceها و متدها را در قالب گراف مشاهده کنید.",
      },
      languageToggle: {
        js: "JavaScript / TS",
        csharp: "C#",
      ...
      editor: {
        title: "ویرایشگر کد",
        placeholderJs:
          "// کد JavaScript یا TypeScript خود را اینجا قرار دهید...",
        placeholderCsharp: "// کد C# خود را اینجا قرار دهید...",
        placeholderJava: "// کد Java خود را اینجا قرار دهید...",
        modeBadgeJs: "حالت JavaScript / TypeScript",
        modeBadgeCsharp: "حالت C#",
        modeBadgeJava: "حالت Java",
        linesSuffix: "خط",
        hintTitle: "راهنما:",
        hintJs:
          "ساختارهایی مثل کلاس، توابع، async/await و فراخوانی متدها بهتر شناسایی می‌شوند.",
        hintCsharp:
          "کلاس‌ها، متدهای public/private و فراخوانی متدهای async شناسایی می‌شوند.",
        hintJava:
          "کلاس‌ها، interfaceها، enumها و متدهای public/private شناسایی می‌شوند.",
        debounceDesktop: "تحلیل خودکار چند لحظه بعد از توقف تایپ انجام می‌شود.",
        debounceMobile:
          "روی موبایل، برای عملکرد بهتر ممکن است تحلیل کمی با تأخیر انجام شود.",
      },
      graph: {
        ...
        emptyDescription:
          "هنوز گره‌ای برای نمایش وجود ندارد. کد معتبر وارد کنید تا ساختار آن در قالب گراف نمایش داده شود.",
      ...
      mobile: {
        ...
        betterOnDesktop:
          "برای تجربه بهتر و مشاهده گراف‌های بزرگ، استفاده از دسکتاپ پیشنهاد می‌شود.",
      },
      tips: {
      ...
      page: {
        ...
        description:
          "ساختار داخلی کد خود را با نمودار گرافی تعاملی بررسی کنید و ارتباط بین اجزا را بهتر درک کنید.",
      },
    },
  },
  en: {
    ...
    description:
      "Turn your JavaScript, C# or Java code into an interactive graph to explore its structure and relationships.",
    features: [
      "Supports JavaScript/TypeScript, C# and Java code",
    ...
    ui: {
      header: {
        ...
        subtitleJs:
          "Paste your JavaScript/TypeScript code to see its structure as an interactive graph.",
        subtitleCsharp:
          "Paste your C# code to visualize classes, methods and their relationships.",
        subtitleJava:
          "Paste your Java code to visualize classes, interfaces and methods as a graph.",
      },
      languageToggle: {
        js: "JavaScript / TS",
        csharp: "C#",
      ...
      editor: {
        ...
        placeholderJava: "// Paste your Java code here...",
        modeBadgeJs: "JavaScript / TypeScript mode",
        modeBadgeCsharp: "C# mode",
        modeBadgeJava: "Java mode",
        linesSuffix: "lines",
        hintTitle: "Hint:",
        hintJs:
          "Classes, functions, async/await and method calls are better recognized.",
        hintCsharp:
          "Classes, public/private methods and async calls are extracted.",
        hintJava:
          "Classes, interfaces, enums and public/private methods are extracted.",
        debounceDesktop:
          "Analysis runs automatically a short moment after you stop typing.",
        debounceMobile:
          "On mobile, analysis may run with a slight delay for better performance.",
      },
      graph: {
        ...
        emptyDescription:
          "There are no nodes to show yet. Paste valid code and the graph will appear here.",
      ...
      mobile: {
        ...
        betterOnDesktop:
          "For large graphs, using a desktop device provides a better experience.",
      },
      tips: {
      ...
      page: {
        ...
        description:
          "Explore the internal structure of your code with an interactive graph of its components and relationships.",
      },
    },
  },
};
