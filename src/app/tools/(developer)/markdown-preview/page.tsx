    ...
    <div className={`min-h-screen flex flex-col ${theme.bg}`}>
      <div className="max-w-6xl mx-auto px-6 pt-10 w-full">
        ...
        <div className="flex items-center gap-4 mb-2">
          ...
          <h1 className={`text-3xl font-bold ${theme.text}`}>پیش‌نمایش مارک‌داون</h1>
        </div>
        
        <p className={`max-w-2xl leading-relaxed mb-8 ${theme.textMuted}`}>
          تایپ کنید و نتیجه زنده کدهای Markdown خود را ببینید. پشتیبانی از جداول، لیست‌ها و کد بلاک‌ها.
        </p>
      </div>
