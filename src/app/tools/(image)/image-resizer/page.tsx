// app/tools/(image)/image-resizer/page.tsx
import type { Metadata } from "next";
import ImageResizerClient from "./ImageResizer";
import { getImageResizerSeo } from "./content";

// سئوی هر دو زبان
const fa = getImageResizerSeo("fa");
const en = getImageResizerSeo("en");
