// app/tools/(image)/image-to-pdf/page.tsx
import type { Metadata } from "next";
import ImageToPdfClient from "./ImageToPdf";
import { getImageToPdfSeo } from "./content";

// سئوی هر دو زبان
const fa = getImageToPdfSeo("fa");
const en = getImageToPdfSeo("en");
