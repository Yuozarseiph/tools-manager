...
import ImageConverterClient from "./ImageConverter";
import { getImageConverterSeo } from "./content";

// سئوی هر دو زبان
const fa = getImageConverterSeo("fa");
const en = getImageConverterSeo("en");
