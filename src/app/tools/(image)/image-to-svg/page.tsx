// app/tools/(image)/image-to-svg/page.tsx

import type { Metadata } from "next";
import ImageToSvgClient from "./ImageToSvg";
import { getImageToSvgSeo } from "./content";

// سئوی هر دو زبان
const fa = getImageToSvgSeo("fa");
const en = getImageToSvgSeo("en");

// عنوان و توضیح ترکیبی
  ...
  return [
    {
      ...
      url: fa.canonical,
      applicationCategory: fa.applicationCategory ?? "ImageApplication",
    ...
    },
    {
      ...
      url: en.canonical,
      applicationCategory: en.applicationCategory ?? "ImageApplication",
