...
import BackgroundRemoverClient from "./BackgroundRemover";
import { getBackgroundRemoverSeo } from "./content";

const fa = getBackgroundRemoverSeo("fa");
const en = getBackgroundRemoverSeo("en");
