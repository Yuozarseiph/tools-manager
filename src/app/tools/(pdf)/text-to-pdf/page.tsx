// app/tools/(pdf)/text-to-pdf/page.tsx
import type { Metadata } from "next";
import TextToPdfClient from "./TextToPdf";
import { getTextToPdfSeo } from "./content";

// سئوی هر دو زبان
const fa = getTextToPdfSeo("fa");
const en = getTextToPdfSeo("en");
