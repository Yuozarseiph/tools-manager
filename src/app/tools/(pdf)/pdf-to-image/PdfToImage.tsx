// app/tools/(pdf)/pdf-to-image/PdfToImage.tsx
"use client";
...
import PdfToImageConverter from "@/components/tools/pdf/pdf-to-image/PdfToImageConverter";
import { usePdfToImagePageContent } from "./content";
import { useLanguage } from "@/context/LanguageContext";

export default function PdfToImageClient() {
  const theme = useThemeColors();
  const { locale } = useLanguage();
  const page = usePdfToImagePageContent();
