// app/tools/(pdf)/pdf-merge/page.tsx
import type { Metadata } from "next";
import PdfMergeClient from "./PdfMerge";
import { getPdfMergeSeo } from "./content";

// سئوی هر دو زبان
const fa = getPdfMergeSeo("fa");
const en = getPdfMergeSeo("en");
