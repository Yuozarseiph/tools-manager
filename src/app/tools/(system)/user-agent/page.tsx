// app/tools/(system)/user-agent/page.tsx
import type { Metadata } from "next";
import UserAgentClient from "./UserAgent";
import { getUserAgentSeo } from "./content";

// سئوی هر دو زبان
const fa = getUserAgentSeo("fa");
const en = getUserAgentSeo("en");
