// app/tools/(system)/ip-checker/page.tsx
import type { Metadata } from "next";
import IPCheckerClient from "./IPChecker";
import { getIPCheckerSeo } from "./content";

// سئوی هر دو زبان
const fa = getIPCheckerSeo("fa");
const en = getIPCheckerSeo("en");
