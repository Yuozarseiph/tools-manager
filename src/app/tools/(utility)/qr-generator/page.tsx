    ...
    <div className={`min-h-screen flex flex-col ${theme.bg}`}>
      ...
      <div className="max-w-6xl mx-auto px-6 pt-10 w-full">
        ...
        <div className="flex items-center gap-4 mb-2">
          ...
          <h1 className={`text-3xl font-bold ${theme.text}`}>سازنده QR Code</h1>
        </div>
        
        <p className={`max-w-2xl leading-relaxed mb-8 ${theme.textMuted}`}>
          لینک، متن یا اطلاعات تماس خود را به یک کد QR زیبا تبدیل کنید. با قابلیت شخصی‌سازی رنگ و اندازه.
        </p>
      </div>
