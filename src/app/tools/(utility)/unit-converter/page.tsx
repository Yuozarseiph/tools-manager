// app/tools/(utility)/unit-converter/page.tsx
import type { Metadata } from "next";
import UnitConverterClient from "./UnitConverter";
import { getUnitConverterSeo } from "./content";

// سئوی هر دو زبان
const fa = getUnitConverterSeo("fa");
const en = getUnitConverterSeo("en");
