// app/tools/(utility)/date-converter/page.tsx
import type { Metadata } from "next";
import DateConverterClient from "./DateConverter";
import { getDateConverterSeo } from "./content";

// سئوی هر دو زبان
const fa = getDateConverterSeo("fa");
const en = getDateConverterSeo("en");
