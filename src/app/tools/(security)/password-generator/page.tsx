...
import PasswordGeneratorClient from "./PasswordGenerator";
import { getPasswordGeneratorSeo } from "./content";

// سئوی هر دو زبان
const fa = getPasswordGeneratorSeo("fa");
const en = getPasswordGeneratorSeo("en");
