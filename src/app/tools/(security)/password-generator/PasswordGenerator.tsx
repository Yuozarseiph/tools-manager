// app/tools/(security)/password-generator/PasswordGenerator.tsx
"use client";
...
import PasswordGeneratorTool from "@/components/tools/security/password-generator/PasswordGeneratorTool";
import { usePasswordGeneratorPageContent } from "./content";
import { useLanguage } from "@/context/LanguageContext";

export default function PasswordGeneratorClient() {
  const theme = useThemeColors();
  const { locale } = useLanguage();
  const page = usePasswordGeneratorPageContent();
