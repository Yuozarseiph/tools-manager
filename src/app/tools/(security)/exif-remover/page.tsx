// app/tools/(security)/exif-remover/page.tsx

import type { Metadata } from "next";
import ExifRemoverClient from "./ExifRemover";
import { getExifRemoverSeo } from "./content";

// سئوی هر دو زبان
const fa = getExifRemoverSeo("fa");
const en = getExifRemoverSeo("en");
