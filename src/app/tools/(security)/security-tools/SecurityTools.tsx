// app/tools/(security)/security-tools/SecurityTools.tsx
"use client";
...
import SecurityToolsMain from "@/components/tools/security/security-tools/SecurityToolsMain";
import { useSecurityToolsPageContent } from "./content";
import { useLanguage } from "@/context/LanguageContext";

export default function SecurityToolsClient() {
  const theme = useThemeColors();
  const { locale } = useLanguage();
  const page = useSecurityToolsPageContent();
