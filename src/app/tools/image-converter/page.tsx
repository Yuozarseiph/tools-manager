    ...
    <div className={`min-h-screen flex flex-col ${theme.bg}`}>
      <div className="max-w-5xl mx-auto px-6 pt-10 w-full">
        ...
        <div className="flex items-center gap-4 mb-2">
          ...
          <h1 className={`text-3xl font-bold ${theme.text}`}>مبدل فرمت تصویر</h1>
        </div>
        
        <p className={`max-w-2xl leading-relaxed ${theme.textMuted}`}>
          تبدیل تصاویر به JPG, PNG و WebP با نهایت کیفیت.
          <span className="block mt-1 text-xs opacity-70">⚡ پردازش در کسری از ثانیه در مرورگر شما</span>
        </p>
      </div>
