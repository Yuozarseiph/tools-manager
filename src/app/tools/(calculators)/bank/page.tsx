// app/tools/(calculators)/bank/page.tsx
import type { Metadata } from "next";
import BankToolsClient from "./BankTools";
import { getBankToolsSeo } from "./content";

// سئوی هر دو زبان
const fa = getBankToolsSeo("fa");
const en = getBankToolsSeo("en");
  ...
  return [
    {
      ...
      url: fa.canonical,
      applicationCategory: fa.applicationCategory ?? "FinanceApplication",
    ...
    },
    {
      ...
      url: en.canonical,
      applicationCategory: en.applicationCategory ?? "FinanceApplication",
